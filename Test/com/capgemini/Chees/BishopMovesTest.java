...
public class BishopMovesTest {
	...
	Field from;
	@Test
	public void shouldReturn7possibleMovesFor04postion() {
	...
	@Test
	public void shouldReturn7possibleMovesFor00postion() {
		List<Move> possibleMoves = new ArrayList<Move>();
	...
	@Test
	public void shouldReturn13possibleMovesFor44postion() {
		List<Move> possibleMoves = new ArrayList<Move>();
	...
	@Test
	public void shouldReturn7possibleMovesFor77postion() {
		List<Move> possibleMoves = new ArrayList<Move>();
