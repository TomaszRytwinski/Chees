...
/**
 * Class Board The class has a composition of chessman. It is used for managing
 * the chess board.
 */
public class Board {
	...
	/**
	 * The constructor creates empty bpard filled with empty chessman (to avoid
	...
	/**
	 * The method that sets begining state on board
	 */
	...
	/**
	 * The method sets chessman in check state
	 */
	...
	/**
	 * The method moves a chessman from Field to Field and create empty chessman
	 * on from Field
	 */
	...
	/**
	 * The method returns color of field, true if it is white
	 */
	...
	/**
	 * The method returns chessman from Y, X
	 */
	...
	/**
	 * The method checks correctnes of coordinates
	 */
